...
.look-away .ears, .look-away .eyes, .look-away .muzzle {
	transition-duration: .3s;
	animation: 3s infinite alternate;
}

.look-away.up .ears, .look-away.up .eyes, .look-away.up .muzzle {
	transform: rotate3d(.2, 0, 0, 20deg) !important;
}

.look-away.down .ears, .look-away.down .eyes, .look-away.down .muzzle {
	transform: rotate3d(-.2, 0, 0, 20deg) !important;
}

.look-away.playing.up .ears, .look-away.playing.up .eyes, .look-away.playing.up .muzzle
	{
	animation-name: lookaway-up;
}

.look-away.playing.down .ears, .look-away.playing.down .eyes, .look-away.playing.down .muzzle
	{
		...
		<div
			...
			<ul class="h-100 float-left m-0 p-0" style="list-style: none;">
				<a href="${pageContext.request.contextPath}/home" class="h-100">
					<li class="h-100 float-left" style="line-height: 3.0;"><img
						src="${pageContext.request.contextPath}/img/logo.png"
						style="width: 30px; height: 30px;"></li>
					<li class="h-100 float-left mx-2"><span
						style="font-size: 35px; font-family: 'Cafe24Oneprettynight'; color: #3D516B;">PIC
							SELL</span></li>
				</a>
			</ul>
		</div>
			...
			<c:when test="${loginInfo == null and adminInfo == null }">
				<div
					...
					<ul class="h-100 float-right mx-3 my-0" style="list-style: none;">
						<li class="h-100 float-left mx-2 mx-sm-3 mx-md-4"
							style="line-height: 3.0;"><a
							href="${pageContext.request.contextPath}/contest/contest.do"
							class="text-dark">공모전</a></li>
						<li class="h-100 float-left mx-2 mx-sm-3 mx-md-4"
							style="line-height: 3.0;"><a
							href="${pageContext.request.contextPath}/writer/writer.do"
							class="text-dark">작가 홈</a></li>
						<li class="h-100 float-left mx-2 mx-sm-3 mx-md-4"
							style="line-height: 3.0;"><a href="#"
							class="text-dark explanation" data-toggle="modal"
							data-target="#Login">로그인</a></li>
						<div class="modal fade" id="Login" role="dialog"
							aria-labelledby="Label" aria-hidden="true" style="top: 110px;">
							<div class="modal-dialog" role="document">
								<div class="modal-content" style="margin: auto; width: 430px;">
									<div class="modal-body text-center"
										style="font-family: 'Cafe24Oneprettynight';">
						            ...
						            <circle cx="60" cy="60" r="40" fill="#e0a243"
													stroke="#000" stroke-width="2.5" />
						            <g class="eyes">
						                <!-- left eye and eyebrow-->
						                <line x1="37" x2="50" y1="46" y2="46"
													stroke="#000" stroke-width="3" stroke-linecap="round" />
						                <circle cx="44" cy="55" r="3" fill="#000" />
						                <!-- right eye and eyebrow -->
						                <line x1="70" x2="83" y1="46" y2="46"
													stroke="#000" stroke-width="3" stroke-linecap="round"
													id="righteye" />
	            					...
	            					<path
											...
											<input type="text" placeholder="Input Your ID" name="loginId"
												id="loginId" style="font-family: 'Dovemayo-Medium';"><br>
											<input type="password" placeholder="Input Your PW"
												name="loginPw" id="loginPw"
												style="font-family: 'Dovemayo-Medium';"><br>
											<div id="info" style="font-size: 20px; display: none">잘못된
												아이디 또는 잘못된 패스워드입니다.</div>
											<div class="form-group p-0 save" style="width: 300px;">
												<div class="form-check p-0 m-0" style="width: 130px;">
													<input class="form-check-input" type="checkbox" value=""
														id="saveId" style="cursor: pointer;" required> <label
														class="form-check-label" for="saveId"
														style="cursor: pointer;">아이디 저장</label>
												</div>
											</div>
									...
									<div class="modal-footer">
										<table class="m-auto text-center"
											...
											<tr class="m-auto w-100">
												...
												<td class="td"><a
													href="${pageContext.request.contextPath}/member/findid.do">아이디
														찾기</a>
												<td class="td"><a
													href="${pageContext.request.contextPath}/member/findpw.do">비밀번호
														찾기</a>
											</tr>
										</table>
									</div>
				...
				<div
					...
					<ul class="h-100 float-right mx-3 my-0" style="list-style: none;">
						...
						<li class="h-100 float-left mx-2 mx-sm-3 mx-md-4"
							style="line-height: 3.0;"><a href="#"
							class="text-dark explanation" data-toggle="modal"
							data-target="#AdminInfo">내 정보</a></li>
						<div class="modal fade" id="AdminInfo" tabindex="-1" role="dialog"
							aria-hidden="true">
							<div class="modal-dialog modal-dialog-slideout" role="document"F
								style="max-width: 350px; left: 17px;">
										...
										<div class="w-100 text-left"
											...
											<div class="row my-2" style="font-size: 20px;">
												<div class="col-12 mb-2">
													<a href="#" style="color: black; text-decoration: none;">관리자
														페이지</a>
												</div>
												<div class="col-12 sideMenu">
													<a href="#"
														style="color: black; font-size: 16px; text-decoration: none;">관리자
														정보 조회</a>
												</div>
												<div class="col-12 sideMenu">
													<a href="member/manage.do"
											...
											<div class="row my-2" style="font-size: 20px;">
												...
												<div class="col-12 sideMenu">
													<a href="#"
														style="color: black; font-size: 16px; text-decoration: none;">공지사항</a>
												</div>
												<div class="col-12 sideMenu">
													<a href="#"
														style="color: black; font-size: 16px; text-decoration: none;">편집의뢰게시판</a>
												</div>
												<div class="col-12 sideMenu">
													<a href="#"
														style="color: black; font-size: 16px; text-decoration: none;">작품의뢰게시판</a>
												</div>
											</div>
											<hr>
											<div class="row my-2" style="font-size: 20px;">
											...
											<div class="row my-4 text-center" style="font-size: 20px;">
												<div class="col-12">
													<a id="logout" href="#" class="btn"
														style="width: 150px; border: 1px solid darkgray; border-radius: 10px; background-color: white;">로그아웃</a>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="modal-dialog modal-dialog-slideout" role="document"
								...
								<div class="modal-content px-2">
									<div class="modal-body m-0">
										...
										<div class="w-100 text-left"
											style="font-family: 'Cafe24Oneprettynight';">
											<h5 class="text-center" style="font-size: 22px;">${loginInfo }님<br>환영합니다
											</h5>
											<hr>
											...
											<div class="row my-3 text-center" style="font-size: 20px;">
												<div class="col-12">
													<a href="#" class="btn py-0"
														style="width: 150px; border: 1px solid darkgray; border-radius: 10px; background-color: white;">충전/환급하기</a>
												</div>
											</div>
											<hr>
											<div class="row my-2" style="font-size: 20px;">
											...
											<div class="row my-2" style="font-size: 20px;">
												<div class="col-12 mb-2">
													<a href="#" style="color: black; text-decoration: none;">나의
														작가 페이지</a>
												</div>
												<div class="col-12 sideMenu">
													<a href="#"
														style="color: black; font-size: 16px; text-decoration: none;">작가
														정보 조회</a>
												</div>
												<div class="col-12 sideMenu">
												...
												<div class="col-12 sideMenu">
													<a href="#"
														style="color: black; font-size: 16px; text-decoration: none;">수익금
														내역 조회</a>
												</div>
											</div>
											<hr>
