...
<body>
	...
	<label>phone<input type="text" id="phone" value="${memberDto.phone }" readonly></label>
	<label>zipcode<input type="text" id="zipcode" value="${memberDto.zipcode }" readonly></label>
	<label>addr1<input type="text" id="addr1" value="${memberDto.addr1 }" readonly></label>
	<label>addr2<input type="text" id="addr2" value="${memberDto.addr2 }" readonly></label>
