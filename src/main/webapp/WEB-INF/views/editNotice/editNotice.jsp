...
<head>
<meta charset="UTF-8">
<title>EditNotice | PicSell</title>
<style>
		...
		<div class="container mx-auto my-5">
			<table id="example" class="row-border" style="width: 100%; text-align: center;">
				...
				<tbody style="font-size: 18px;">
					<c:forEach var="editNoticeList" items="${editNoticeList }">
...
<script>
		...
		$("#writeBtn").on("click", function(){
			location.href="${pageContext.request.contextPath}/editNotice/noticeWrite.do";
		})
	</script>
</body>
</html>