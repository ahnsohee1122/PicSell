...
<head>
<meta charset="UTF-8">
<title>EditNotice Write | PicSell</title>
<style>
...
<jsp:include page="../key/top.jsp" flush="false"/>
	...
	<div class="container-fluid py-5" style="background-color: #f4f2f5; font-family: 'Cafe24Oneprettynight';">
		<div class="container m-auto">
			<h2 class="mx-auto my-0 text-center">편집의뢰 등록</h2>
		</div>
		<div class="container mx-auto my-5">
			<form action="${pageContext.request.contextPath}/editNotice/writeProc.do" enctype="multipart/form-data" method="post" id="frm">
				<table style="width: 100%;">
					<tr>
						<td>제목</td>
						<td><input type="text" id="editNotice_title" name="editNotice_title" class="w-100 px-2"></td>
					</tr>
					<tr>
						<td>첨부파일</td>
						<td>
						<input type='file' name='editNoticeFile_file' multiple='multiple'>
						</td>
					</tr>
					<tr>
