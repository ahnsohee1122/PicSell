...
<body>
	<div class="container-fluid m-0 p-0" style="min-height: 968px; background-color: #f4f2f5; font-family: 'Cafe24Oneprettynight';">
 		...
 		<div class="container mx-auto my-5 py-5 text-center">
 			<h5>아래의 버튼을 눌러주세요!!</h5>
 			<input type="button" value="픽셀 홈으로 가기" style="border: 1px solid darkgray; background-color: #f4f2f5; width: 150px; height: 40px; border-radius: 10px;">
 		</div>
	</div>
</body>
</html>